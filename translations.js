...
const translations = {
    en: {
        ...
        "step-1-description": "Sign up on the Solar Share platform to connect with local solar projects and collaborate on renewable energy initiatives.",
    ...
    ro: {
        ...
        "step-1-description": "Înscrieți-vă pe platforma Solar Share pentru a vă conecta cu proiectele solare locale și a colabora la inițiativele de energie regenerabilă.",
    ...
    ru: {
        ...
        "step-1-description": "Зарегистрируйтесь на платформе Solar Share, чтобы подключиться к местным солнечным проектам и сотрудничать над инициативами в области возобновляемой энергии.",
